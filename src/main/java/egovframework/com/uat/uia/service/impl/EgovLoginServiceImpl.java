...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	 ...
	 */
	@Override
	public LoginVO actionAuthLogin(LoginVO vo) throws Exception {

		// 1. 본인인증 결과값으로 회원정보 조회.
		LoginVO loginVO = loginDAO.actionAuthLogin(vo);
	 ...
	 */
	@Override
	public void updatePassword(LoginVO pwVO) throws Exception {
		loginDAO.updatePassword(pwVO);
	}
}
