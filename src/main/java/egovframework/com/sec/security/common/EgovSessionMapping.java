...
public class EgovSessionMapping extends EgovUsersByUsernameMapping {
    ...
    protected EgovUserDetails mapRow(ResultSet rs, int rownum) throws SQLException {
        ...
        //진주 목공예 전수관 데이터추가
        String strUserZip    = rs.getString("user_zip");
        String strUserAdres    = rs.getString("user_adres");
        String strUserAdresDtl    = rs.getString("user_adres_dtl");
        String strUserHp    = rs.getString("user_hp");
        ...
        //진주 목공예 전수관 데이터추가
        loginVO.setZip(strUserZip);
        loginVO.setAdres(strUserAdres);
        loginVO.setAdresDtl(strUserAdresDtl);
        loginVO.setHp(strUserHp);
