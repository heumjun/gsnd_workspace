...
import com.twogoms.woodcraft.service.cmm.MenuService;
import egovframework.com.cmm.EgovWebUtil;
import egovframework.com.utl.cas.service.EgovSessionCookieUtil;
import egovframework.com.utl.fcc.service.EgovStringUtil;
import egovframework.com.utl.sim.service.EgovNetInfo;
...
public class CommonController {
    ...
    public ModelAndView pageHeader(HttpServletRequest request,
        ...
        if (EgovSessionCookieUtil.getSessionAttribute(request, WoodCraftConstant.SessionAttribute.MENU_LIST) != null) {
            menuList = (List<MenuDto>)EgovSessionCookieUtil.getSessionAttribute(request, WoodCraftConstant.SessionAttribute.MENU_LIST);
        } else {
            ...
            EgovSessionCookieUtil.setSessionAttribute(request, WoodCraftConstant.SessionAttribute.ALL_MENU_LIST, allMenuList);
            EgovSessionCookieUtil.setSessionAttribute(request, WoodCraftConstant.SessionAttribute.MENU_LIST, menuList);
        }
    ...
    public ModelAndView pageSidebar(HttpServletRequest request,
        ...
        List<MenuDto> menuList = (List<MenuDto>) EgovSessionCookieUtil.getSessionAttribute(request, WoodCraftConstant.SessionAttribute.ALL_MENU_LIST);
        if (menuList == null) {
