...
<layout:extends name="mngBase">
    <layout:put block="title" type="REPLACE">체험신청(취소)</layout:put>
            ...
            <div class="article-header">
                <nav class="curr-nav">
                    <ul>
                        ...
                        <li><a class="on" href="#">체험신청(취소)</a></li>
                    </ul>
                </nav>
            </div>
            <section class="sub">
                ...
                <!-- content -->
                <h2 class="title-h2">체험신청(취소) 상세</h2>
                <div class="form">
    ...
    <layout:put block="javascript" type="REPLACE">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                alert("${message}");
                if ("${result}" == "OK") {
                    document.location.href = "<c:url value="/mng/exprn/exprnRefdList.do" />";
                }
                </c:if>
                ...
                $("#btn_list").click(function() {
                    ...
                    $('<form/>').appendTo("#content").attr('action','<c:url value="/mng/exprn/exprnRefdList.do" />').append($(input)).submit();
                });
                ...
                $("#btn_submit").click(function() {
                    ...
                    $("#WcrfBuyForm").attr("action",'<c:url value="/mng/exprn/exprnRefdSave.do" />')
                        .submit();
                });
