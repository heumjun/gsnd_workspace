            ...
            <section class="sub">
                ...
                <div class="pagination">
                    ...
                    <div class="btn-container align-right">
                        <span class="button medium icon"><span class="check ico_new"></span><a href='<c:url value="/mng/exprn/exprnRegit.do"/>' id="btn_banner_add">등록</a></span>
                    </div>
                </div>
                <!-- Pagination(Common) -->
            </section>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("a[data-exprn-id]").click(function(event) {
                    ...
                    var view_url = "<c:url value="/mng/exprn/exprnView.do"/>";
