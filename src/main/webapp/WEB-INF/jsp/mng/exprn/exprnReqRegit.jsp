                        ...
                        <fieldset>
                            ...
                            <table class="template-table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="align-left">
                                        <input type="text" id="txt_exprnDay" name="exprnDay" class="k-textbox" style="width:100%;" value="${WcrfBuyForm.exprnDay}" disabled/>
                                    </td>
                                    <td class="align-left font-weight-bold"><label for="txt_exprnTime">체험시간</label></td>
                                    <td colspan="2" class="align-left">
                                        <input type="text" id="txt_exprnTime" name="exprnTime" class="k-textbox" style="width:100%;" value="${WcrfBuyForm.exprnTime}" disabled/>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
    ...
    <layout:put block="javascript" type="REPLACE">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                alert("${message}");
                if ("${result}" == "OK") {
                    document.location.href = "<c:url value="/mng/exprn/exprnReqList.do" />";
                }
                </c:if>
                ...
                $("#btn_list").click(function() {
                    ...
                    $('<form/>').appendTo("#content").attr('action','<c:url value="/mng/exprn/exprnReqList.do" />').append($(input)).submit();
                });
                ...
                $("#btn_submit").click(function() {
                    ...
                    $("#WcrfBuyForm").attr("action",'<c:url value="/mng/exprn/exprnReqSave.do" />')
                        .submit();
                });
