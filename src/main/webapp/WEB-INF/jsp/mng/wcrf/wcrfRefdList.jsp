                        ...
                        <div class="search-form">
                            <table class="two_search1">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input type="text" id="txt_searchByerNm" name="searchByerNm" class="k-textbox" value="${frmSearch.searchByerNm}"></td>
                                    <td><label class="two_label_ic1">구매일시</label></td>
                                    <td><input id="txt_searchPurchsDt" /></td>
                                    <td class="btns1" rowspan="2">
                                        <button id="btn_search" class="h_r2" type="submit">
                                            검색
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><label class="two_label_ic1">반품사유</label></td>
                                    <td><input id="txt_searchRefdResnCd" /></td>
                ...
                <table class="template-table" summary="목공예품목록">
                    ...
                    <c:forEach var="result" items="${resultList}" varStatus="status">
                        <tr>
                            ...
                            <td><span class="font-color-gray">${result.refdResnCdNm}</span></td>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#btn_search").click(function() {
                    ...
                    select = $("#txt_searchPurchsProgrsSttus").data("kendoComboBox");
                ...
                $("a[data-purchsLst-id]").click(function(event) {
                    ...
                    var view_url = "<c:url value="/mng/wcrf/wcrfRefdRegit.do"/>";
