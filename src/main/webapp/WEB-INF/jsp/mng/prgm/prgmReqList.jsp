                            ...
                            <fieldset>
                                <table class="two_search1">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="txt_searchByerNm" name="searchByerNm"
                                                   class="k-textbox" value="${frmSearch.searchByerNm}"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><input type="text" id="txt_searchPurchsDesc" name="searchPurchsDesc" class="k-textbox" value="" style="width:55%;"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" id="txt_searchApplyDtFr" data-type="date" style="width:130px;">&nbsp;~&nbsp;
                                            <input type="text" id="txt_searchApplyDtTo" data-type="date" style="width:130px;"></td>
                                    </tr>
                                </table>
                            </fieldset>
                        </form:form>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("a[data-purchsLst-id]").click(function(event) {
                    ...
                    var view_url = "<c:url value="/mng/prgm/prgmReqRegit.do"/>";
