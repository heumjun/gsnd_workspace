        ...
        <article id="content">
            ...
            <section class="sub">
                    ...
                    <form:form commandName="board" id="board" method="post">
                        ...
                        <fieldset>
                            ...
                            <table class="template-table">
                                <caption class="display-none">게시물등록</caption>
                                <colgroup>
                ...
                <div class="btn-container align-right">
                    ...
                    <span class="button medium icon">
                       <span class="check ico_save"></span>
                       <button id="btn_submit2" type="button">
                           답변
                       </button>
                    </span>
                    <c:choose>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#btn_submit").click(function() {
                    ...
                    $("#board").attr("action",'<c:url value="/mng/community/save/${boardId}.do" />')
                ...
                $("#btn_submit2").click(function() {
                    var nttId = '${board.nttId}';
                    var boardId ='${boardId}';
                    var view_url = "<c:url value="/mng/community/reply/${boardId}.do"/>";
                    ...
                    $("<form />")
                        ...
                        .append($("<input />").attr("type","hidden").attr("name","boardId").val(boardId))
                        .submit();
                });
