...
<% 
/**
 * @Class Name : EgovScrapRegist.jsp
 * @Description : 스크랩 등록
...
<script type="text/javascript">
	function fn_egov_regist_scrap() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.scrap.action = "<c:url value='/cop/scp/insertScrap.do'/>";
...
<form:form commandName="scrap" name="scrap" method="post" action="${pageContext.request.contextPath}/cop/scp/insertScrap.do' />">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="스크랩에 대한 정보를 등록합니다.">
	<tbody>
	  <tr> 
...
<c:out value="${board.nttCn}" escapeXml="false" />	
	...
	<tr>
	  <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_regist_scrap(); return false;"></span></td>
      <td width="10"></td>
      <td><span class="button"><a href="#" onclick="fn_egov_cancel(); return false;"><spring:message code="button.reset" /></a></span></td>
	</tr>
	</table>
	</div>
</form:form>
