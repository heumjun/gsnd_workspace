			...
			<table width="700" cellpadding="8" class="table-search" border="0">
			 <tr>
			  <td width="700"class="title_left"><h1 class="title_left">
			   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;발송메일 등록</h1></td>
			 </tr>
			</table>
		  </td>
		</tr>
		<tr>
		  <td>
			...
			<CAPTION style="display: none;">발송메일 등록</CAPTION>
			  <tr>
			    <th scope="row" width="100" height="23" class="required_text" nowrap ><label for="recptnPerson">받는사람</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
			    <td width="600" nowrap>
			  ...
			  <tr>
			    <th scope="row" width="100" height="23" class="required_text" nowrap ><label for="sj">제목</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
			    <td width="600" nowrap>
		  ...
		  <td>
			<table border="0" cellspacing="0" cellpadding="0" align="right">
			  <tr>
			    ...
			    <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnBack(); return false;">뒤로</a>
			    </td>
