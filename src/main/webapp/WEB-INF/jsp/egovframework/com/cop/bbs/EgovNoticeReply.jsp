	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목버튼이미지">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
	  ...
	  <tr>
	    ...
	    <td colspan="3">
	      ...
	      <tr><td>
	      <textarea id="nttCn" name="nttCn" class="textarea"  cols="75" rows="28"  style="width:550px;" title="답글내용입력"></textarea>
