...
<div id="border" style="width:730px">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%" class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">
	   &nbsp;문자메시지 상세조회</td>
	 </tr>
	</table>
	...
	<tbody>
	  <tr>
	    <th width="15%" height="23" nowrap class="required_text"><spring:message code="cop.sms.trnsmitTelno" /><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택사항"></th>
	    <td width="85%" colspan="3" nowrap><c:out value="${result.trnsmitTelno}" />
	    </td>
	  </tr>
	  <tr>
	    <th height="23" class="required_text"><spring:message code="cop.sms.trnsmitCn" /><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택사항"></th>
	    <td colspan="3">
	  ...
	  <tr>
	    <th width="15%" height="23" nowrap class="required_text">수신 및 전송결과<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택사항"></th>
	  ...
	  <tr>
	    <th width="15%" height="23" nowrap class="required_text">전송자<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택사항"></th>
	    <td width="15%" class="lt_text3" nowrap>
	   		<c:out value="${result.frstRegisterNm}" />
	    </td>
	    <th width="15%" height="23" nowrap class="required_text">전송시간<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택사항"></th>
