		...
		<form name="listForm" action="<c:url value='/cop/ems/selectSndngMailList.do'/>" method="post">
			...
			<table width="700" cellpadding="8" class="table-search" border="0">
			  <tr>
			    ...
			    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;발송내역 조회</h1></td>
			    <th></th>
			    <td width="100">
			    ...
			    <th width="150">
			      <table border="0" cellspacing="0" cellpadding="0">
			        <tr>
				      ...
				      <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnDelete(); return false;">삭제</a>
				      </td>
