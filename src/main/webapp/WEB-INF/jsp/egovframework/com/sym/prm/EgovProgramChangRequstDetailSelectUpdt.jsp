...
<%--
  ...
  */
  /* Image Path 설정 */
  //String imagePath_icon   = "/assets/images/egovframework/com/sym/prm/icon/";
  //String imagePath_button = "/assets/images/egovframework/com/sym/prm/button/";
--%>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;프로그램변경요청 상세조회 /수정</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;변경요청내역</td>
 </tr>
</table>
