...
<table width="100%" class="table-search" border="0">
 <tr>
  <td width="150"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;서버S/W 관리</h1>
  </td>
...
<table width="100%" cellpadding="8" class="table-list" summary="서버정보에 대한 목록을 제공한다.">
 ...
 <c:forEach var="server" items="${serverList}" varStatus="status">
  <tr>
    ...
    <!-- <td class="lt_text3" nowrap><a href="<c:url value='/assets/images/egovframework/com/cmm/icon/search2.gif'/>" width="15" height="15" alt=""></a></td>-->
    <td class="lt_text3" nowrap><a href="#" onClick="windowOpen('<c:out value="${server.serverId}"/>')"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search2.gif'/>" width="15" height="15" alt=""></a></td>
  </tr>
 </c:forEach>
 </tbody>
</table>
