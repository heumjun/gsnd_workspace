 ...
 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td class="title_left"><h1 class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;송수신 로그조회</h1></td>
	  <th>
	 ...
	 <c:forEach var="result" items="${resultList}" varStatus="status">
	  <tr>
	    ...
	    <a href="#noscript" onclick="fn_egov_inqire_trsmrcvLog('<c:out value="${result.requstId}"/>'); return false;"
	    	...
	    	<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif'/>"  alt="상세보기(새창)"
