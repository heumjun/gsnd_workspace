...
<table width="700" cellpadding="8" class="table-search" border="0" summary="기관코드상세정보테이블">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;기관코드 상세조회</td>
 </tr>
</table>
...
<c:if test="${result.insttCode != null}">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >기관코드<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.insttCode}"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >전체기관명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.allInsttNm}"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >변경일자<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >변경시간<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >폐지유무<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
