...
-->
<!-- FIREFOX -->
<iframe title="상위행정구역코드" name="ifadminist" src="<c:url value='/sym/ccm/adc/EgovCcmAdministCode.do'/>" style="width:600px; height:500px;" frameborder=0></iframe>
