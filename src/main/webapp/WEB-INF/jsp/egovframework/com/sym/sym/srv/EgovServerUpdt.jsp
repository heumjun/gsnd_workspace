...
<table border="0">
  <tr>
    ...
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="100%" class="title_left"><h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;서버S/W 수정</h1></td>
     </tr>
     <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="서버S/W를 수정한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버S/W ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버S/W 명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버S/W 종류<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
      ...
      <tr>
        ...
        <td class="lt_text" nowrap><label for="regstYmd">
            ...
            <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(document.server, document.server.registerDate, document.server.regstYmd);" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/sym/cal/bu_icon_carlendar.gif'/>" title="새창" alt="달력창팝업버튼이미지"></a>
