...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   ...
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;기관코드수신 목록</td>
  <th>
  </th>
  <td width="10%">
...
<!--
      ...
      <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif' />);" class="text_left" nowrap>
