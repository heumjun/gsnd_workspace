...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통분류코드 목록</h1></td>
  <th>
  </th>
  <td width="10%">  		
  ...
  <th width="15%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <!--
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif' />" alt="조회" width="8" height="20"></td>
      <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnSearch(); return false;">조회</a></td>
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif' />" alt="조회" width="8" height="20"></td>
      <td width="10"></td>
      -->
      <td><span class="button"><input type="submit" value="조회" onclick="fnSearch(); return false;"></span></td>
      <td width="10"></td>
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif' />" alt="등록" width="8" height="20"></td>
      <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnRegist(); return false;">등록</a></td>
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif' />" alt="등록" width="8" height="20"></td>
    </tr>
   </table>
  </th>
 </tr>
