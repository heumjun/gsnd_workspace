...
<input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
 ...
 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;로그인 로그조회</td>
	  <th>
	   발생일자
	  </th>
	  <td>
	 ...
	 <c:forEach var="result" items="${resultList}" varStatus="status">
	  <tr>
	    ...
	    <a href="javascript:fn_egov_inqire_loginLog('<c:out value="${result.logId}"/>');"
	    	...
	    	<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif'/>"
