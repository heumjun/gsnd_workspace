 ...
 <table width="700" cellpadding="8" class="table-search" border="0">
	 ...
	 <tr>
	  <td class="title_left"><h1 class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;시스템 로그조회</h1></td>
	  <th>
