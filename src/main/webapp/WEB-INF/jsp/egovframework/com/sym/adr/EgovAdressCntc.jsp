...
<script type="text/JavaScript" src="/assets/js/egovframework/com/cmm/jquery-1.4.2.min.js"></script>
...
function getAddrLocTest(){
	$.ajax({
		 url :"${contextPath}/sym/adr/getAdressCntcTestApi.do"
		,type:"post"
		,data:$("#form").serialize()
		,dataType:"xml"
		,success:function(xmlStr){
...
<form name="form" id="form" method="post">
 <table width="700" cellpadding="8" class="table-search" border="0">
   <tr>
	  <td class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;주소 정보 연계</td>
   </tr>
   <tr>
     <th>현재 페이지</th>
