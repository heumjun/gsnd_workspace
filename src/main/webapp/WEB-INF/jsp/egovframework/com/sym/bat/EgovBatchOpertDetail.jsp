...
<form name="batchOpertForm"  id="batchOpertForm" action="<c:url value='/sym/bat/getBatchOpert.do'/>" method="post">
    ...
    <table width="100%" cellpadding="8" class="table-search" border="0" summary="제목테이블">
     <tr>
      <td width="100%"class="title_left">
       <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;배치작업 상세조회</h1></td>
     </tr>
    </table>
    <!--  줄간격조정  -->
    ...
    <!-- 등록  폼 영역  -->
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary=" 배치작업 상세정보 테이블.">
      <caption>배치작업 상세조회</caption>
      <tr> 
        <th width="20%" height="23" class="required_text" scope="row" nowrap="nowrap" >배치작업ID</th>
        <td width="80%">
    ...
    <tr> 
        <td>
            <span class="button">
            <a href="<c:url value='/sym/bat/getBatchOpertForUpdate.do'>
                     </c:url>"
