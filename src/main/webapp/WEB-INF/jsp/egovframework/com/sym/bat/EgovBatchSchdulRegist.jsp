...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;배치스케줄 등록</h1></td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<!--  등록  폼 영역  -->
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="배치스케줄등록을 위한 테이블.">
  <caption>배치스케줄 등록</caption>
  <!--
  <tr>
    <th width="15%" height="23" class="required_text" scope="row" nowrap ><label for="batchSchdulId">배치스케줄ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="85%" nowrap>
        <form:input path="batchSchdulId" size="20" maxlength="20" disabled="true"  cssClass="readOnlyClass"/>
        <form:errors path="batchSchdulId" cssClass="error" />
    </td>
  </tr>
   -->
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="batchOpertId">배치작업ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td nowrap>
        ...
        <a href="#LINK" onClick="javascript:fn_egov_popup_batch_opert_list(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search2.gif' />"
                    width="15" height="15" style="vertical-align: middle" alt="배치작업조회팝업 제공"></a>
    </td>
  </tr>

  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="batchOpertNm">배치작업명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    ...
    <td>
        ...
        <img src="<c:url value='/assets/images/egovframework/com/sym/cal/bu_icon_carlendar.gif'/>"  style="vertical-align: middle; border:0px" alt="달력창팝업버튼이미지">
        </a>
        </span>
        <span id="spnMonth">
