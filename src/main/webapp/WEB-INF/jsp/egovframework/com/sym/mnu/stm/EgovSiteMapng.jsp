...
<link rel="stylesheet" href="<c:url value='/assets/css/egovframework/com/uss/umt/map.css' />" type="text/css">
<title>사이트맵</title>
<style type="text/css">
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목아이콘이미지">&nbsp;사이트맵</td>
  <td width="10%">&nbsp;</td>
  <td widht="25%">&nbsp;</td>
  <th width="25%"></th>
 </tr>
