...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="35%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;상위행정구역코드 목록</h1></td>
  <th>
  </th>
	  <td width="25%">
