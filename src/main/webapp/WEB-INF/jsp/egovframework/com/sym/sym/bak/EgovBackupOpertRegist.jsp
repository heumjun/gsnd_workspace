...
<script type="text/javascript" src="<c:url value='/assets/js/egovframework/com/cmm/utl/EgovCmmUtl.js' />"></script>
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;백업작업 등록</h1></td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<!--  등록  폼 영역  -->
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="백업작업등록을 위한 테이블.">
  <caption>백업작업 등록</caption>
  <!--
  <tr>
    <th width="15%" height="23" class="required_text" scope="row" nowrap ><label for="backupOpertId">백업작업ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="85%" nowrap>
        <form:input path="backupOpertId" size="20" maxlength="20" disabled="true" cssClass="readOnlyClass"/>
        <form:errors path="backupOpertId" cssClass="error" />
    </td>
  </tr>
   -->
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="backupOpertNm">백업작업명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="backupOrginlDrctry">백업원본디렉토리</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="backupStreDrctry">백업저장디렉토리</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" scope="row" nowrap ><label for="executCycle">실행주기</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label for="cmprsSe">압축구분</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
