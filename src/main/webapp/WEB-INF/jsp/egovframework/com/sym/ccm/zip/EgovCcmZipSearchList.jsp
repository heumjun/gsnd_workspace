...
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/css/egovframework/com/sym/ccm/zip/zip.css' />" >
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/css/egovframework/com/button.css' />" >
...
<table style="width:650px;margin:0 auto" cellpadding="8" class="table-search" border="0">
 <tr>
  <td style="width:40%" class="title_left">
		<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지" /> 우편번호 찾기
  </td>
  <td>
