...
<body>
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;로그인 로그 정보</td>
	 </tr>
	</table>
	...
	<tr>
      ...
      <a href="<c:url value='/sym/log/clg/SelectLoginLogList.do' />">이전</a>
      </td>
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>

	  <!-- <td><span class="button"><input type="submit" value="이전" onclick="javascript:window.close()"></span></td> -->
	</tr>
	</table>
</body>
</html>
