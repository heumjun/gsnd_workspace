...
<%
String imagePath_icon   = "/assets/images/egovframework/com/sym/mnu/bmm/icon/";
String imagePath_button = "/assets/images/egovframework/com/sym/mnu/bmm/button/";
%>
<html lang="ko">
...
<table width="200" cellpadding="8" class="table-search" border="0">
    <tr>
    	<td width="10%" >
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/utl/menu_base.gif' />" width="20" height="20" hspace="3" style="vertical-align: middle" alt = "base icon">
		    </td>
	 ...
	 <c:forEach var="result" items="${list_menulist}" varStatus="status">
		  <tr>
		    ...
		    <td >
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/utl/menu_page.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt = "menu_page icon" >
		   		    </td>
		    <td class="lt_text1">
