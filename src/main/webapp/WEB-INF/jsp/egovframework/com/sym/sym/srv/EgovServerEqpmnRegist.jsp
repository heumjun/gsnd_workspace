...
<table border="0">
  <tr>
    ...
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="100%" class="title_left"><h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">서버H/W 등록</h1></td>
     </tr>
     <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="서버H/W 를 등록한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>기타정보<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt=""></label></th>
