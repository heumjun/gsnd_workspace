		...
		<DIV id="content" style="width:712px">
			...
			<form:form commandName="processMonVO" name="processMonVO" method="post">
				...
				<table width="700" cellpadding="8" class="table-search" border="0">
				 	<tr>
				  		<td width="100%"class="title_left">
				   		<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;프로세스모니터링 등록</h1></td>
				 	</tr>
				</table>
				...
				<caption>프로세스모니터링 등록</caption>
					<tr>
					    <th scope="row" width="20%" height="23" class="required_text">프로세스명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수항목" title="필수항목" width="15" height="15"></th>
					    <td width="80%">
