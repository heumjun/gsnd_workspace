...
<html lang="ko">
	...
	<body onLoad="fn_egov_initl_ProcessMon();">
		...
		<form name="listForm" action="<c:url value='/utl/sys/prm/EgovComUtlProcessMonList.do'/>" method="post">
			<table width="100%" cellpadding="8" class="table-search" border="0">
 				<tr>
  					<td width="30%" class="title_left">
   					<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;프로세스모니터링 목록</h1></td>
					<td width="20%">
   						<select name="searchCondition" class="select" title="조회조건 선택">
		   					<option value=''>--선택하세요--</option>
		   					<option value='1' <c:if test="${searchVO.searchCondition == '1'}">selected="selected"</c:if>>프로세스명</option>
    				...
    				<input name="searchKeyword" type="text" size="35" value="${searchVO.searchKeyword}"  maxlength="35" title="검색어 입력"> 
  					...
  					<th width="30%">
   						<table border="0" cellspacing="0" cellpadding="0">
	    					<tr> 
	      						<td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif'/>" alt="조회버튼" title="조회버튼" width="8" height="20"></td>
	      						...
	      						<td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif'/>" alt="조회버튼" title="조회버튼" width="8" height="20"></td>
      							<td>&nbsp;</td>
							    <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif'/>" alt="등록버튼" title="등록버튼" width="8" height="20"></td>
							    <td class="btnBackground"><a href="<c:url value='/utl/sys/prm/EgovComUtlProcessMonRegist.do'/>"><spring:message code="button.create" /></a></td>
							    <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif'/>" alt="등록버튼" title="등록버튼" width="8" height="20"></td>
      							<td>&nbsp;</td>
	      						<td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif'/>" alt="조회버튼" title="조회버튼" width="8" height="20"></td>
			...
			summary="이 표는 프로세스모니터링 대상 정보를 제공하며, 순번, 프로세스명, 상태, 관리자명, 관리자이메일, 생성일시로 구성되어 있습니다 .">
			<caption>프로세스모니터링 목록</caption>
				<thead>
					<tr>
						<th scope="col" class="title" width="10%" nowrap="nowrap">순번</th>					
						<th scope="col" class="title" width="15%" nowrap="nowrap">프로세스명</th>					
						<th scope="col" class="title" width="10%" nowrap="nowrap">상태</th>						
						<th scope="col" class="title" width="15%" nowrap="nowrap">관리자명</th>
						<th scope="col" class="title" width="25%" nowrap="nowrap">관리자이메일</th>
				...
				<tbody>					  										
					<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
						<tr>
							...
							<td class="lt_text3">${resultInfo.procsSttus}</td>
							<td class="lt_text3">${resultInfo.mngrNm}</td>														
							<td class="lt_text3">${resultInfo.mngrEmailAddr}</td>
