...
<html lang="ko">
	...
	<noscript class="noScriptTitle">자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다.</noscript>
		...
		<div id="border" style="width:730px">
				...
				<table width="100%" cellpadding="8" class="table-search" border="0">
					<tbody>
		 				<tr>
   							...
   							<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;프로세스모니터링로그 목록</h1></td>
		    				...
		    				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" style="border:0px;vertical-align: bottom" alt="달력창팝업버튼이미지"></a>
		    				...
		    				<input name="searchKeyword" type="text" size="27" value='<c:out value="${searchVO.searchKeyword}"/>' maxlength="35" onkeypress="press(event);" title="검색어 입력">
		  					...
		  					<td width="10%">
								<table border="0" cellspacing="0" cellpadding="0">
								    <tr>
								      	<td><span class="button"><input type="submit" value="조회" onclick="fn_egov_select_processMonLog('1'); return false;"></span></td>
		      							<td>&nbsp;</td>
			...
			<table width="100%" cellpadding="2" class="table-list" summary="이 표는 프로세스모니터링 로그 정보를 제공하며, 순번, 로그ID, 프로세스명, 상태, 생성일시 정보로 구성되어 있습니다 .">
			<caption>프로세스모니터링로그 상세조회</caption>
		 		<thead>
		  			<tr>
		    			<th scope="col" class="title" width="10%">순번</th>
					    <th scope="col" class="title" width="30%">로그ID</th>
					    <th scope="col" class="title" width="20%">프로세스명</th>
					    <th scope="col" class="title" width="15%">상태</th>
					    <th scope="col" class="title" width="25%">생성일시</th>
		  			</tr>
		 		</thead>
		 		<tbody>
				 	<c:forEach var="result" items="${resultList}" varStatus="status">
				  		<tr>
							...
							<td class="lt_text3"><c:out value="${result.procsSttus}"/></td>
