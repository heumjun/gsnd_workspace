...
function fn_egov_list(){
    var varForm = document.getElementById("trsmrcvMntrngForm");
 ...
 ******************************************************** */
 function fn_egov_delete(){
        var vForm = document.trsmrcvMntrngForm;
...
<form name="trsmrcvMntrngForm"  id="trsmrcvMntrngForm" action="<c:url value='/utl/sys/trm/getTrsmrcvMntrng.do'/>" method="post">
    ...
    <table width="100%" cellpadding="8" class="table-search" border="0">
     <tr>
      <td width="100%"class="title_left">
       <img src="<c:out value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;송수신모니터링 상세조회</td>
     </tr>
    </table>
    <!--  줄간격조정  -->
    ...
    <!-- 등록  폼 영역  -->
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="등록된 송수신모니터링에 대한 상세정보를 제공합니다.">
      <tr> 
    ...
    <tr> 
        <td>
            <span class="button">
            <a href="<c:url value='/utl/sys/trm/getTrsmrcvMntrngForUpdate.do'/>"
