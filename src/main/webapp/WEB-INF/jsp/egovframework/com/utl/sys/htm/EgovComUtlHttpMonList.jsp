...
<html lang="ko">
	<head>
		...
		<script type="text/javascript" src="/assets/js/egovframework/com/cmm/utl/EgovCmmUtl.js"></script>
			...
			<table width="100%" cellpadding="8" class="table-search" border="0">
 				<tr>
  					<td width="30%" class="title_left">
   					<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;HTTP모니터링 목록</h1></td>
					<td width="20%">
  					...
  					<th width="30%">
   						<table border="0" cellspacing="0" cellpadding="0">
	    					<tr> 
							    ...
							    <td class="btnBackground"><a href="<c:url value='/utl/sys/htm/EgovComUtlHttpMonRegist.do'/>"><spring:message code="button.create" /></a></td>
