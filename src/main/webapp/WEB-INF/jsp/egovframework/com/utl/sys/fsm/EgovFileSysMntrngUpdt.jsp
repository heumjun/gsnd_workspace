...
<form:form commandName="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/updateFileSysMntrng.do">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는 파일시스템모니터링 대상 정보를  수정하기 위한 표이며, 파일시스템명, 파일시스템관리명, 파일시스템 크기, 파일시스템 임계치, 관리자명, 관리자이메일주소 정보로 구성되어 있습니다 .">
	<caption>파일시스템모니터대상 수정</caption>
	<tbody>
	  <tr> 
		<th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysNm">파일시스템명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
		<td width="80%" >
			<form:input path="fileSysNm" size="50" maxlength="60" title="파일시스템명"/>
		</td>
	  </tr>
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysManageNm">파일시스템관리명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysMg">파일시스템 크기</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="fileSysThrhld">파일시스템 임계치</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="mngrNm">관리자명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	  ...
	  <tr> 
	    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="mngrEmailAddr">관리자이메일주소</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수항목"></th>
	    <td width="80%" >
	...
	<tr>
	  <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_update_filesysmntrng(); return false;"></span></td>
      <td>&nbsp;&nbsp;</td>
