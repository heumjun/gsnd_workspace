...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;송수신모니터링 등록</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="송수신모니터링 등록을 제공한다.">
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="idCntcId" for="cntcId">연계ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="80%" nowrap>
        <form:input path="cntcId" size="10" maxlength="8" readonly="true" cssClass="readOnlyClass"/>
        <form:errors path="cntcId" cssClass="error" />
        <a href="#LINK" onClick="javascript:fn_egov_popup_cntc_list(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search2.gif' />"
                    width="15" height="15" style="vertical-align: middle" alt="연계정보조회팝업 제공"></a>
    </td>
  </tr>
  
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="idCntcNm" for="cntcNm">연계명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="idTestClassNm" for="testClassNm">테스트클래스명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
