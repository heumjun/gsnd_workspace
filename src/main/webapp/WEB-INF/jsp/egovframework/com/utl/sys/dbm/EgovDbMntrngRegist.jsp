...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;DB서비스모니터링 등록</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="DB서비스모니터링 등록을 제공한다.">
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdDataSourcNm" for="dataSourcNm">데이타소스명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdServerNm" for="serverNm">서버명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdDbmsKind" for="dbmsKind">DBMS종류</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdCeckSql" for="ceckSql">체크SQL</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrNm" for="mngrNm">관리자명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrEmailAddr" for="mngrEmailAddr">관리자이메일주소</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
