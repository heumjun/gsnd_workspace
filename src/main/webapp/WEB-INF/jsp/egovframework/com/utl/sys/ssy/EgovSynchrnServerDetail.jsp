...
<table border="0">
  <tr>
    ...
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="100%" class="title_left"><h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;동기화대상 서버정보 상세조회</h1></td>
     </tr>
     <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="동기화대상 서버에 대해 상세정보를 조회한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.serverId}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.serverNm}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버 IP<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.serverIp}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서버 Port<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.serverPort}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>FTP ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.ftpId}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>FTP 비밀번호<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
        <td class="lt_text" nowrap><c:out value='${synchrnServer.ftpPassword}'/></td>
      </tr>
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>동기화 위치<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt=""></th>
...
<!-- 
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="20" class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="타이틀"></td>
        ...
        <table width="100%" class="table-search" border="0">
         <tr>
          <td width="305" class="title_left">
            <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="" />&nbsp;동기화 파일 목록</h1>
          </td>
