...
<table width="100%" class="table-search" border="0">
 <tr>
  <td width="200" class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;동기화대상 서버 관리</h1>
  </td>
        ...
        <table width="100%" class="table-search" border="0">
         <tr>
          <td width="325" class="title_left">
           <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;동기화대상 파일 등록</h1>
          </td>
        </tr>
        <tr>
        ...
        <table width="100%" class="table-search" border="0">
         <tr>
          <td width="305" class="title_left">
            <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="" />&nbsp;동기화대상 파일 목록</h1>
          </td>
