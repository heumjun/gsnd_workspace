...
<link rel="stylesheet" type="text/css" href="<c:url value='/assets/css/egovframework/com/common.css'/>" >
<script type="text/javaScript" language="javascript" src="<c:url value='/assets/js/egovframework/com/uat/uia/EgovGpkiVariables.js'/>"></script>
<script type="text/javaScript" language="javascript" src="<c:url value='/assets/js/egovframework/com/uat/uia/EgovGpkiInstall.js'/>"></script>
<script type="text/javaScript" language="javascript" src="<c:url value='/assets/js/egovframework/com/uat/uia/EgovGpkiFunction.js'/>"></script>
...
<img src="<c:url value='/assets/images/egovframework/com/main_top02.jpg'/>" alt="egovframe" />
<table width="700" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="350" height="250">
          ...
          <form name="loginForm" action ="<c:url value='/uat/uia/actionLogin.do'/>" method="post">
            ...
            <table width="303" border="0" cellspacing="8" cellpadding="0">
              <tr>
                <td width="40%"class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="login">&nbsp;일반로그인</td>
              </tr>
              <tr>
                <td width="303" height="210" valign="top" style="background:url(<c:url value='/assets/images/egovframework/com/uat/uia/login_bg01.gif' />) no-repeat;">
      ...
      <td width="350" height="250">
		...
		<input name="iptSubmit2" type="submit" value="전송" title="전송">
            ...
            <table width="303" border="0" cellspacing="8" cellpadding="0">
              <tr>
                <td width="40%"class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="gpki_login">&nbsp;인증서 로그인</td>
              </tr>
              <tr>
                <td width="303" height="210" valign="top" style="background:url(<c:url value='/assets/images/egovframework/com/uat/uia/login_bg01.gif'/>) no-repeat;">
                    <table width="303" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="700">
    <tr>
      <td class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="gpki_icon">&nbsp;인증서 로그인을 위한 설치</td>
    </tr>
    <tr>
  ...
  <table width="700">
    <tr>
      <td class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;OAuth 로그인</td>
    </tr>
  </table>
    <!-- TWITTER SIGNIN -->
    <form id="tw_signin" action="<c:url value="/signin/twitter"/>" method="POST" target="_blank">
        <button type="submit" style="width:151px; height:26px; background-image: url('<c:url value="/assets/images/egovframework/com/ext/oauth/twitter/sign-in-with-twitter-d.png"/>');"/>
    </form>
    ...
    <form name="fb_signin" id="fb_signin" action="<c:url value="/signin/facebook"/>" method="POST" target="_blank">
        ...
        <button type="submit" style="width:151px; height:26px; background-image: url('<c:url value="/assets/images/egovframework/com/ext/oauth/facebook/sign-in-with-facebook.png"/>');"/>
    </form>
