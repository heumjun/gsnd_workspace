    ...
    <tr>
      <td width="350" height="250">
	      ...
	      <form name="idForm" action ="<c:url value='/uat/uia/searchId.do'/>" method="post">
			<table width="303" border="0" cellspacing="8" cellpadding="0">
		      <tr>
				<td width="40%"class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목아이콘이미지">&nbsp;아이디 찾기</td>
		      </tr>
		      <tr>
							    ...
							    <td>
									<table border="0" cellspacing="0" cellpadding="0">
									  <tr>
										...
										<td background="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><center><a href="javascript:fnSearchId();">아이디찾기</a></center></td>
      ...
      <td width="350" height="250">
	    ...
	    <form name="passwordForm" action ="<c:url value='/uat/uia/searchPassword.do'/>" method="post">
			<table width="303" border="0" cellspacing="8" cellpadding="0">
		      <tr>
				<td width="40%"class="title_left"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목아이콘이미지">&nbsp;비밀번호 찾기</td>
		      </tr>
		      <tr>
				<td width="303" height="210" valign="top">
					<table width="303" border="0" align="center" cellpadding="0" cellspacing="0">
						      ...
						      <tr>
							    ...
							    <td>
									<table border="0" cellspacing="0" cellpadding="0">
									  <tr>
									    <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
										<td background="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><center><a href="javascript:fnSearchPassword();">비밀번호찾기</a></center></td>
										<td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
									  </tr>
									</table>
								</td>
