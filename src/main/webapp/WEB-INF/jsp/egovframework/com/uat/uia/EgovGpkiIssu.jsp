  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  <td align="left" valign="top">
        ...
        <tr>
          <td>
          <img src="<c:url value='/assets/images/egovframework/com/uat/uia/01_t01.gif' />" width="131" height="13"><br>
        ...
        <tr>
          <td>
            <table cellpadding="0" cellspacing="0" border="0" width="572">
              <tr>
                <td>
            <img src="<c:url value='/assets/images/egovframework/com/uat/uia/01_t02.gif' />" width="97" height="13"><br>
        ...
        <tr>
          <td>
          <img src="<c:url value='/assets/images/egovframework/com/uat/uia/01_t03.gif' />" width="72" height="13"><br>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    <td width="15" align="left"><img src="<c:url value='/assets/images/egovframework/com/uat/uia/icon01.gif' />" width="9" height="13" alt="개요모양아이콘이미지"/></td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td bgcolor="#DFF0C7" width="1"></td>
                    <td width="452" align="left"><div style="margin:6px;">인증관리센터는 안전행전부 장관이 지정ㆍ고시하는 정부인증기관을 대상으로 인증업무 수행등에 활용하도록 인증서를 발급합니다.</div></td>
                    <td bgcolor="#DFF0C7" width="1"></td>
                    </tr>
                    <tr>
                    <td colspan="5" bgcolor="#DFF0C7" height="1"></td>
        ...
        <tr>
          <td>
            <table width="572" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="<c:url value='/assets/images/egovframework/com/uat/uia/01_t04.gif' />" width="111" height="13"><br>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DFF0C7">
                    ...
                    <td><div style="margin:6px;">ou=보안관리팀,   ou=전자정부본부, ou=안전행전부, o=Government of Korea, c=KR</div></td>
                    </tr>
                    <tr bgColor="#ffffff">
                    ...
                    <td><div style="margin:6px;">cn=기관구분자(3)   + 이름 + 일련번호(3)<BR>
                      *일련번호:동명이인 </div></td>
                    <td><div style="margin:6px;">cn=001홍길동001,   ou=people, ou=안전행전부, o=Government of Korea, c=KR</div></td>
                    </tr>
                  </table>               </td>
             </tr>
            </table>          </td>
