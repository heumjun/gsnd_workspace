...
<table width="700" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   	<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;연계메시지 등록</h1>
  </td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<!-- 등록  폼 영역  -->
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="연계메시지 등록을 제공한다.">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >연계메시지ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >연계메시지명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
		<select name="upperCntcMessageId" class="select" title="상위연계메시지ID선택">
...
<tr>
	<td>
		...
		<tr>
		  <td>
		  	<span class="button"><input type="submit" value="저장" title="저장" onclick="fn_egov_regist_CntcMessage(document.cntcMessage); return false;" ></span>
		  </td>
		  <td>
		 ...
		 <!-- 
		  ...
		  <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif' />);" class="text_left" nowrap><a href="<c:url value='/ssi/syi/ims/getCntcMessageList.do'/>">목록</a></td>
