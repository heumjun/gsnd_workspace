...
<table width="700" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   	<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;연계시스템 수정</h1>
  </td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<!-- 등록  폼 영역  -->
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="연계시스템  수정을 제공한다.">
  <tr>
  ...
  <tr>
    ...
    <td width="80%" nowrap><c:out value='${cntcSystem.sysId}'/></td>
  </tr>
  <tr>
...
<tr>
	<td>
		...
		<tr>
		  ...
		  <input type="submit" value="저장" title="저장" onclick="fn_egov_modify_CntcSystem(document.cntcSystem); return false;" ></span></td>
		  <td width="10"></td>
