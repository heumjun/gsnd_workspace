...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   	<h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;연계기관 상세조회</h1>
  </td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >연계기관ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.insttId}"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >연계기관명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" alt="필수입력표시"  width="15" height="15"></th>
 ...
 <tr>
  ...
  <form name="formCntcSystemRegist" action="<c:url value='/ssi/syi/iis/addCntcSystem.do'/>" method="post">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif' />" alt="연계시스템등록" width="8" height="20"></td>
      ...
      <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif' />" alt="연계시스템등록" width="8" height="20"></td>
      <td width="10"></td>
    </tr>
   </table>
   <input name="insttId" type="hidden" value="<c:out value='${result.insttId}'/>">
