...
<table width="100%" cellpadding="1" class="table-search" border="0">
 <tr>
  <td class="title_left">
	<h1>
  		<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="행사/이벤트/캠페인 목록 팝업">&nbsp;행사/이벤트/캠페인 목록 팝업
  	</h1>
  </td>
  </tr>
  <tr>
