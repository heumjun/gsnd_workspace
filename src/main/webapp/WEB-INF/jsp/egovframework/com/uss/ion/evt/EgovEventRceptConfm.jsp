...
<script type="text/javaScript" language="javascript">
	 ...
	 ******************************************************** */
	 function fncConfmEventRcept(){
		...
		window.showModalDialog("<c:url value='/uss/ion/ism/EgovConfmPopup.do'/>", arrParam,"dialogWidth=780px;dialogHeight=170px;resizable=yes;center=yes");
	 }
	 ...
	 ******************************************************** */
	 function fncReturnEventRcept(){
		...
		window.showModalDialog("<c:url value='/uss/ion/ism/EgovReturnPopup.do'/>", arrParam,"dialogWidth=780px;dialogHeight=170px;resizable=yes;center=yes");
	 }
...
<!-- ********** 여기서 부터 본문 내용 *************** -->
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;행사접수승인관리 목록</h1>
	  </td>
	  <td width="50%">&nbsp;</td>
	  <th width="10%">
	...
	<caption>행사접수승인 검색조건</caption>
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchSe">행사구분</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
	    <td width="30%" >
	    ...
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchYear">행사년월</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
	    <td width="30%">
	  ...
	  <tr>
	    <th width="20%" height="23" class="required_text" scope="row"><label for="searchNm">행사명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
