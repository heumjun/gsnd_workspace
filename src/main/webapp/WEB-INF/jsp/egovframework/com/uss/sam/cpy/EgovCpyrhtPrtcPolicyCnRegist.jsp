...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="left" alt="제목아이콘이미지">&nbsp;저작권보호정책내용등록</h1></td>
 </tr>
</table>
...
<!-- 등록  폼 영역  -->
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는  저작권보호정책내용 정보를  등록하기 위한 표이며, 저작권보호정책내용 정보로 구성되어 있습니다 .">
  <caption>저작권보호정책내용 등록</caption>
  <tr>
    <th scope="row" height="23" class="required_text" width="25%"><label for="cpyrhtPrtcPolicyCn">저작권보호정책내용</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수항목"></th>
    <td>
      <form:textarea path="cpyrhtPrtcPolicyCn" cols="300" rows="20" cssClass="txaClass" title="저작권보호정책내용"/>
...
<tr>
  <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_regist_cpyrhtprtcpolicycn(document.forms[0]); return false;"></span></td>
  <td>&nbsp;&nbsp;</td>
