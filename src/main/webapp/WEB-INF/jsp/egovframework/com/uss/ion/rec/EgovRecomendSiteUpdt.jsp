...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="제목 정보테이블">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목이미지">&nbsp;추천사이트수정</td>
 </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="추천사이트 정보 수정테이블">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="idConfmDe" for="confmDe">승인일자</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력"></th>
    <td width="80%" nowrap>
