...
<table border="0">
  <tr>
    <td width="700">
<form:form commandName="deptManage" method="post" action="${pageContext.request.contextPath}/uss/umt/dpt/updtDeptManage.do' />">
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="90%" class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;부서 수정
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line">
  <tr>
    <th class="required_text" width="20%" nowrap>부서ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td class="lt_text" nowrap><input name="orgnztId" id="orgnztId" type="text" value="<c:out value='${deptManage.orgnztId}'/>" size="30" class="readOnlyClass" readonly title="부서명ID"></td>
  </tr>
  <tr>
    <th class="required_text" width="20%" nowrap>부서명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td class="lt_text" nowrap>
        <input name="orgnztNm" id="orgnztNm" type="text" value="<c:out value='${deptManage.orgnztNm}'/>" maxLength="10" size="30" >&nbsp;<form:errors path="orgnztNm" title="부서명"/></td>
  </tr>
  <tr>
    <th class="required_text" width="20%" nowrap>설명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
    <td class="lt_text" nowrap><input name="orgnztDc" id="orgnztDc" type="text" value="<c:out value='${deptManage.orgnztDc}'/>" maxLength="255" size="50" >&nbsp;<form:errors path="orgnztDc" title="설명"/></td>
  </tr>
</table>
