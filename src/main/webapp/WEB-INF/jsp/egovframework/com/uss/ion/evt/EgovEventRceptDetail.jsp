...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="30%"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;행사접수신청 상세</h1></td>
  <td width="60%">&nbsp;</td>
...
<caption>행사접수관리 상세</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">신청자<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="30%"  ><c:out value='${eventManageVO.eventTemp6}'/></td>
    <th width="20%" height="23" class="required_text"  scope="row">소속<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사목적<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventPurps}'/></td>    
  </tr> 

  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사기간<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사주최<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventAuspcInsttNm}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사주관<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventMngtInsttNm}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사장소<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3"><c:out value='${eventManageVO.eventPlace}'/></td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">참조URL<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사내용<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3">
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">참가비용<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"  colspan="3"> 
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">정원<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"   colspan="3"><c:out value='${eventManageVO.psncpa}'/>
    </td>    
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row">행사접수기간<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%"   colspan="3">
