...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;인터넷서비스안내 수정</h1>
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line" summary="인터넷서비스정보를 수정한다">
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>인터넷서비스ID<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>인터넷서비스명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>인터넷서비스설명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
    <td>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>반영여부<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>등록일시<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
