...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="" />&nbsp;기업회원 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원아이디<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
                <td width="80%" nowrap><label for="entrprsmberId">
                    ...
                    <a href="#LINK" onclick="fnIdCheck()">
                        <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif' />" alt="" />
                    (중복아이디 검색)</a></label>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    사업자등록번호<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사전화번호<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
                ...
                <td width="80%" nowrap><label for="zip_view">
                    ...
                    <form:hidden path="zip" />
                        <a href="#LINK" onclick="fn_egov_ZipSearch(document.entrprsManageVO, document.entrprsManageVO.zip, document.entrprsManageVO.zip_view, document.entrprsManageVO.adres);">
                            <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif' />" alt="" />(우편번호 검색)
                        </a></label>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이름<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이메일주소<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원상태코드<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
