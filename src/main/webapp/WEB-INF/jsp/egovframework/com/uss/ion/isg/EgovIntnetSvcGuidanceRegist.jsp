...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;인터넷서비스안내 등록</h1>
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line" summary="인터넷서비스정보를 등록한다">
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>인터넷서비스설명<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="선택입력표시"></th>
    <td>
