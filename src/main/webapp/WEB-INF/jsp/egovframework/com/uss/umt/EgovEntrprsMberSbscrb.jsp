...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;기업회원 가입신청</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
                ...
                <td width="80%" nowrap>
                    ...
                    <a href="javascript:fnIdCheck();">
                        <img align="middle" src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif' />" alt="검색아이콘이미지">(중복아이디 검색)
                    </a>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    주소<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
                <td width="80%" nowrap>
