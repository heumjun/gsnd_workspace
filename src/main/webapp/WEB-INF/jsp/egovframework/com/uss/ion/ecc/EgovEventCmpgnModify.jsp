...
function fn_egov_save_EventCmpgn(){
	...
	if(confirm("저장 하시겠습니까?")){
		...
		if(!validateEventCmpgnVO(varFrom)){
			...
			<%-- 행사시작일자, 행사종료일자 validate --%>
			var eventSvcBeginDe = document.getElementById('eventSvcBeginDe').value;
			var eventSvcEndDe = document.getElementById('eventSvcEndDe').value;
			
			var iChkBeginDe = Number(eventSvcBeginDe.replaceAll("-",""));
			var iChkEndDe = Number( eventSvcEndDe.replaceAll("-","") );

			if(iChkBeginDe > iChkEndDe || iChkEndDe < iChkBeginDe ){
				alert("행사시작일자는 행사종료일자 보다 클수 없고,\n행사종료일자는 행사시작일자 보다 작을수 없습니다. ");
				return;
			}
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;행사/이벤트/캠페인  수정</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >행사유형<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >행사내용<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >행사시작일자<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>
     <input name="eventSvcBeginDe" id="eventSvcBeginDe" type="text" size="73" value="${resultList[0].eventSvcBeginDe}" maxlength="10" style="width:80px;" title="행사시작일자입력">
     <a href="javascript:fn_egov_NormalCalendar(document.forms[0], document.forms[0].eventSvcBeginDe);">
     	<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" align="middle" style="border:0px" alt="달력창팝업버튼이미지" >
     </a>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >행사종료일자<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" nowrap>
   <input name="eventSvcEndDe" id="eventSvcEndDe" type="text" size="73" value="${resultList[0].eventSvcEndDe}" maxlength="10" style="width:80px;" title="행사종료일자입력">
   <a href="javascript:fn_egov_NormalCalendar(document.forms[0], document.forms[0].eventSvcEndDe);">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" style="border:0px" alt="달력창팝업버튼이미지"></a>
  ...
  <tr>
	...
	<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" onClick="" align="middle" style="border:0px" alt="달력창팝업버튼이미지"></a>
    </td>
  </tr>
  </c:if>
</table>
...
<!-- 
  ...
  <td background="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>" class="text_left" nowrap><a href="JavaScript:fn_egov_list_EventCmpgn();">목록</a>
  </td>
  <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
  <td>&nbsp;</td>
  <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_left.gif'/>" width="8" height="20" alt="버튼이미지"></td>
  <td background="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>" class="text_left" nowrap><a href="JavaScript:fn_egov_save_EventCmpgn();">저장</a>
  </td>
  <td><img src="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
 -->
