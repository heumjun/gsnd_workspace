...
<script type="text/javascript" src="<c:url value='/assets/js/egovframework/com/uss/ion/rec/EgovRecomendSite.js' />"></script>
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="제목테이블">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목이미지">&nbsp;추천사이트등록</td>
 </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="추천사이트정보등록테이블">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="idRecomendSiteNm" for="recomendSiteNm">추천사이트명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="idRecomendSiteUrl" for="recomendSiteUrl">추천사이트 URL</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="idRecomendSiteDc" for="recomendSiteDc">추천사이트 설명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="idRecomendResnCn" for="recomendResnCn">추천사유내용</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="idRecomendConfmAt" for="recomendConfmAt">추천승인여부</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력"></th>
    <td>
  ...
  <tr>
    <th height="23" class="required_text" ><label id="idConfmDe" for="confmDe">승인일자</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력"></th>
    <td>
      ...
      <img name="calendarImg" src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"  align="middle" style="border:0px" alt="달력창팝업버튼이미지">
      </a>
