...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="개인정보보호정책 등록">&nbsp;개인정보보호정책 등록</td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="개인정보보호정책  등록을 제공한다.">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdIndvdlInfoNm">개인정보보호정책 명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
  ...
  <tr>
    <th height="23" class="required_text" ><label id="IdIndvdlInfoYn">동의여부</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdIndvdlInfoDc">개인정보보호정책 내용</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
