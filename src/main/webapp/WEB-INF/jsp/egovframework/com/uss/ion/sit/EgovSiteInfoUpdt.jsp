...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="제목테이블">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목이미지">&nbsp;사이트정보 수정</td>
 </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="사이트정보 수정테이블">
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="idSiteNm" for="siteNm">사이트명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th height="23" class="required_text" ><label id="idSiteUrl" for="siteUrl">사이트 URL</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr> 
    <th height="23" class="required_text" ><label id="idSiteDc" for="siteDc">사이트 설명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td> 
  ...
  <tr> 
    <th height="23" class="required_text" ><label id="idSiteThemaClCode" for="siteThemaClCode">사이트주제분류</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr> 
    <th height="23" class="required_text" ><label id="idActvtyAt" for="actvtyAt">활성여부</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
  ...
  <tr> 
    <th height="23" class="required_text" ><label id="idUseAt" for="useAt">사용여부</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력"></th>
    <td>
