...
<c:set var="CssUrl" value="/css/egovframework/com/uss/ion/evt/"/>
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="30%"class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;행사  등록</h1></td>
  <td width="60%">&nbsp;</td>
  <th width="10%" align="right">
       <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><span class="button"><a href="#LINK" onclick="fncEventReqstClear(); return false;">초기화</a></span></td>
          <td>&nbsp;&nbsp;</td>
          <td><span class="button"><input type="submit" value="<spring:message code="button.create" />" onclick="fncInsertEventReqstManage(); return false;"></span></td>
          <td>&nbsp;&nbsp;</td>
...
<!-- 등록  폼 영역  -->
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="행사관리 등록" >
<caption>행사관리 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventSe">행사구분</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventNm">행사명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventPurps">행사목적</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventBeginDe">행사기간</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
    <input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
      ...
      <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(document.eventManage, document.eventManage.eventBeginDe, document.eventManage.eventBeginDe);" title="새 창으로 이동"
    	style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventAuspcInsttNm">행사주최</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventMngtInsttNm">행사주관</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventPlace">행사장소</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="refrnUrl">참조URL</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventCn">행사내용</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
      <form:textarea path="eventCn" rows="4" cols="70" cssClass="txaClass" title="행사내용"/>
      <form:errors path="eventCn"/>
    </td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="ctOccrrncAt">참가비용</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="psncpa">정원</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="rceptBeginDe">행사접수기간</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
