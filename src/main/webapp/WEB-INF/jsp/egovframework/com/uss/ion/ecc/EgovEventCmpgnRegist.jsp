	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
		<tr>
			<td width="100%" class="title_left">
				<h1>
					<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />"
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"
		...
		<tr>
			<th scope="col" width="20%" height="23" class="required_text" nowrap>
				...
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="행사유형">
			</th>
			<td width="80%" nowrap>
		...
		<tr>
			<th scope="col" width="20%" height="23" class="required_text" nowrap>
				...
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="행사내용">
			</th>
			<td width="80%" nowrap>
		...
		<tr>
			<th scope="col" width="20%" height="23" class="required_text" nowrap>
				...
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="행사시작일자">
			</th>
			<td width="80%" nowrap>
				<input name="eventSvcBeginDe" id="eventSvcBeginDe" type="text" size="73" value="" maxlength="10" style="width: 80px;" title="행사시작일자">
				<a href="#LINK" onclick="javascript:fn_egov_NormalCalendar(document.forms[0], document.forms[0].eventSvcBeginDe);">
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" align="middle" style="border: 0px" alt="달력창팝업버튼이미지"></a>
		...
		<tr>
			<th scope="col" width="20%" height="23" class="required_text" nowrap>
				...
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시">
			</th>
			<td width="80%" nowrap>
				<input name="eventSvcEndDe" id="eventSvcEndDe" type="text" size="73" value="" maxlength="10" style="width: 80px;" title="행사종료일자">
				<a href="#LINK" onclick="javascript:fn_egov_NormalCalendar(document.forms[0], document.forms[0].eventSvcEndDe);">
					<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" style="border: 0px" alt="달력창팝업버튼이미지">
				</a>
		...
		<c:if test="${SUserSe eq 'USR'}">
			...
			<tr>
				...
				<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"
