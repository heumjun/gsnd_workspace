...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;로그인화면이미지 수정</h1>
  </td>
 </tr>
</table>

<table width="100%" cellpadding="8" class="table-line" summary="로그인화면이미지를 수정한다.">
  <caption>로그인화면이미지 수정</caption>
  <tr>
    <th class="required_text" width="20%" scope="row"><label for="imageId">이미지ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row"><label for="imageNm">이미지명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td class="lt_text" nowrap><input name="imageNm" id="imageNm" title="이미지명" type="text" value="<c:out value='${loginScrinImage.imageNm}'/>" maxLength="10" size="20" >&nbsp;<form:errors path="imageNm" /></td>
  </tr>
  <tr>
    <th class="required_text" width="20%" scope="row"><label for="egovComFileUploader">이미지</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td class="lt_text" nowrap>
        <input type="file" name="file_1" id="egovComFileUploader" title="이미지파일">&nbsp;
        <input name="image" id="image" title="이미지" type="text" value="<c:out value="${loginScrinImage.image}"/>" maxLength="30" size="30" class="readOnlyClass" readonly >
    </td>
  </tr>
  <tr>
    <th class="required_text" width="20%" scope="row"><label for="imageDc">이미지설명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
  ...
  <tr>
    <td align="center">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fncLoginScrinImageUpdate(); return false;"></span></td>
	      <td>&nbsp;&nbsp;</td>
	      <td><span class="button"><a href="<c:url value='/uss/ion/lsi/removeLoginScrinImage.do'/>?imageId=<c:out value='${loginScrinImageVO.imageId}'/>" onclick="fncLoginScrinImageDelete(); return false;"><spring:message code="button.delete" /></a></span></td>
	      <td>&nbsp;&nbsp;</td>
