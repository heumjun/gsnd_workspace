...
<script type="text/javascript" src="<c:url value='/assets/js/egovframework/com/cmm/showModalDialog.js'/>" ></script>
...
<table width="100%" cellpadding="3" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
	<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;외부인사정보 등록
  </td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="행사/이벤트/캠페인 정보, 성별, 외부인사명, 생년월일, 직업유형, 소속기관, 전화번호, 이메일주소 입니다">
  <tr>
    <th scope="col" width="20%" height="23" class="required_text"><label for="eventCn">행사/이벤트/캠페인 정보</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="행사/이벤트/캠페인 정보" title="행사/이벤트/캠페인 정보"></th>
    <td width="80%" nowrap>
      ...
      <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search2.gif'/>" align="middle" style="border:0px" alt="행사/이벤트/캠페인 정보" title="행사/이벤트/캠페인 정보">
      </a>
      <input name="eventId" id="eventId" type="hidden" value="5">
    </td>
  </tr>
  <tr>
    <th scope="col" height="23" class="required_text"><label for="sexdstnCode">성별</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="성별" title="성별"></th>
    <td>
  ...
  <tr>
    <th scope="col" width="20%" height="23" class="required_text" ><label for="extrlHrNm">외부인사명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="외부인사명" title="외부인사명"></th>
    <td width="80%">
  ...
  <tr>
    <th scope="col" width="20%" height="23" class="required_text" ><label for="brthYYYY">생년월일</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="생년월일" title="생년월일"></th>
    <td width="80%">
  ...
  <tr>
    <th scope="col" width="20%" height="23" class="required_text" nowrap ><label for="occpTyCode">직업유형</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="직업유형" title="직업유형"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="col" width="20%" height="23" class="required_text" nowrap ><label for="areaNo">전화번호</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="전화번호" title="전화번호"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="col" width="20%" height="23" class="required_text" nowrap ><label for="emailAdres">이메일주소</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="이메일주소" title="이메일주소"></th>
    <td width="80%" nowrap>
...
<!-- 
	 ...
	 <td background="<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>" class="text_left" nowrap><a href="JavaScript:fn_egov_save_TnextrlHrInfo();"><spring:message code="button.save" /></a>
  	 </td>
