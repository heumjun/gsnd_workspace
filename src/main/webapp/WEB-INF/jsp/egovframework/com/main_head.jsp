...
<input name="chkURL" type="hidden" />
    ...
    <div id="gnb">
    <div id="top_logo"><a href="<c:url value='/sym/mnu/mpm/EgovMainMenuHome.do' />" target=_top><img src="<c:url value='/assets/images/egovframework/com/logo_01.gif' />" alt="egovframe" /></a></div>
     <div id="use_descri">
            <ul>
                <li>공통서비스 테스트 사이트(업무사용자용)</li>
                 <li><a href="javascript:actionLogout()"><img src="<c:url value='/assets/images/egovframework/com/logout_btn.gif' />" alt="로그아웃" /></a></li>
            </ul>
    </div>
    </div>
    <div id="new_topnavi">
