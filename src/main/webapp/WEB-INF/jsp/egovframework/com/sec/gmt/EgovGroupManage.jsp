...
<link href="<c:url value='/assets/assets/css/egovframework/com/com.css' />" rel="stylesheet" type="text/css">
<title>그룹관리</title>
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="20%" class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;그룹 관리</td>
...
<table width="100%" cellpadding="8" class="table-line" summary="그룹 관리에 관한 테이블입니다.그룹 ID,그룹 명,설명,등록일자의 정보를 담고 있습니다.">
 ...
 <c:forEach var="group" items="${groupList}" varStatus="status">
  <tr>
    ...
    <td class="lt_text3" nowrap="nowrap"><a href="#LINK" onclick="javascript:fncSelectGroup('<c:out value="${group.groupId}"/>')"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/search.gif'/>" width="15" height="15" align="middle" alt="상세조회"></a></td>
