...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="28%" class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">부서권한관리</td>
  <td width="68%">부서<img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"> : <input name="deptCode" type="text" value="<c:out value='${deptAuthorVO.deptCode}' />" size="22" title="부서코드" onkeypress="press();" readOnly />
