...
<table width="100%" cellpadding="1" class="table-search" border="0">
 <tr>
  <td width="22%" class="title_left"><h2 class="title_left">
    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;자료이용현황통계</h2></td>
  ...
  <a href="#noscript" onclick="fn_egov_NormalCalendar(document.listForm, document.listForm.pmFromDate, document.listForm.pmTyFromDate); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
  ~
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
    ...
    <tr>
      ...
      <td width="90%"><img src="<c:url value='/assets/images/egovframework/com/cmm/left_bg.gif'/>" width="<c:out value='${dtaUseStatsBar.grpCnt * dtaUseStatsVO.maxUnit}'/>" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${dtaUseStatsBar.grpCnt}"/> 개</td>
    </tr>
    </c:forEach>
</table>
