...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left"><h1 class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;보고서 등록</h1>
  </td>
 </tr>
</table>
...
<CAPTION style="display: none;">보고서 등록</CAPTION>
  <tr>
    <th scope="row" class="required_text" width="20%" nowrap><label for="reprtId">보고서ID</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th scope="row" class="required_text" width="20%" nowrap><label for="reprtNm">보고서명</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th scope="row" class="required_text" width="20%" nowrap><label for="reprtTy">보고서유형</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
  ...
  <tr>
    <th scope="row" class="required_text" width="20%" nowrap><label for="reprtSttus">진행상태</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
    <td class="lt_text" nowrap>
  ...
  <tr>
    <th scope="row" class="required_text" width="20%" nowrap><label for="regDate">등록일시</label><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
