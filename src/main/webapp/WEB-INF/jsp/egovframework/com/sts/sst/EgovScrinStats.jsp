...
<script type="text/javascript" language="javascript1.2" src="<c:url value='/assets/js/egovframework/com/sts/sst/treemenu.js' />" ></script>
	...
	<form name="listForm" action="<c:url value='/sts/sst/selectScrinStats.do'/>" method="post">
		...
		<table width="700" cellpadding="8" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;화면 통계 검색</h2>
		    </td>
		  </tr>
		  <tr>
		    <td>
		...
		<table width="700" cellpadding="8" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;화면 통계 결과</h2>
		    </td>
		    <td width="300"class="title_left"><h2 class="title_left">
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;공통서비스 메뉴</h2>
		    </td>
		  </tr>
		</table>
