	...
	<form name="listForm" action="<c:url value='/sts/ust/selectUserStats.do'/>" method="post">
		...
		<table width="700" cellpadding="8" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;사용자 통계 검색</h2>
		    </td>
		  </tr>
		  <tr>
		    <td>
		...
		<table width="700" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;사용자 통계 결과</h2>
		    </td>
		  </tr>
		  <tr>
		        ...
		        <c:forEach items="${userStats}" var="resultInfo" varStatus="status">
			      <tr>
			        ...
			        <td width="90%" height="10">
					  <img src="<c:url value='/assets/images/egovframework/com/cmm/left_bg.gif'/>" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}'/>" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;명
					</td>
			      </tr>
			    </c:forEach>
