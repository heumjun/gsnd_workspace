...
<table width="100%" cellpadding="1" class="table-search" border="0">
 <tr>
  <td width="18%" class="title_left"><h2 class="title_left">
   <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;보고서통계</h2></td>
  ...
  <a href="#noscript" onclick="fn_egov_NormalCalendar(document.listForm, document.listForm.pmFromDate, document.listForm.pmTyFromDate); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>~<input type="text" name="pmTyToDate" size="10" maxlength="10" title="종료일자(새창)">
  <a href="#noscript" onclick="fn_egov_NormalCalendar(document.listForm, document.listForm.pmToDate, document.listForm.pmTyToDate); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
  </td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
    <tr>
      ...
      <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;기간별 통계 결과</h2></td>
    </tr>
    ...
    <tr>
      ...
      <td width="90%"><img src="<c:url value='/assets/images/egovframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsBar.grpCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsBar.grpCnt}" /> 개</td>
    </tr>
    </c:forEach>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
    <tr>
      <td width="15%" class="title_left" colspan="2"><h2 class="title_left">
      <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;보고서유형별 통계 결과</h2></td>
    </tr>
    ...
    <tr>
      ...
      <td width="90%"><img src="<c:url value='/assets/images/egovframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsByReprtTy.grpReprtTyCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsByReprtTy.grpReprtTyCnt}" /> 개</td>
    </tr>
    </c:forEach>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
    <tr>
      <td width="15%" class="title_left" colspan="2"><h2 class="title_left">
      <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;진행상태별 통계 결과</h2></td>
    </tr>
    ...
    <tr>
      ...
      <td width="90%"><img src="<c:url value='/assets/images/egovframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsByReprtSttus.grpReprtSttusCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsByReprtSttus.grpReprtSttusCnt}" /> 개</td>
    </tr>
    </c:forEach>
</table>
