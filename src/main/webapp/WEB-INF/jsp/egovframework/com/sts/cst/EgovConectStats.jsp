	...
	<form name="listForm" action="<c:url value='/sts/cst/selectConectStats.do'/>" method="post">
		...
		<table width="660" cellpadding="8" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;접속 통계 검색</h2>
		    </td>
		  </tr>
		  <tr>
		    <td>
				...
				<td width="100">
				  <table border="0" cellspacing="0" cellpadding="0">
			        <tr>
				      ...
				      <td style="background-image:URL(<c:url value='/assets/images/egovframework/com/cmm/btn/bu2_bg.gif'/>);" class="text_left" nowrap>
		...
		<table width="660" cellpadding="8" class="table-search" border="0">
		  <tr>
		    ...
		    <img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;접속 통계 결과
		    </td>
		  </tr>
		  <tr>
