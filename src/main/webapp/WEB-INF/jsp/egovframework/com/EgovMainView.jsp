...
<link rel="stylesheet" href="<c:url value='/assets/css/egovframework/com/cmm/mpm.css' />" type="text/css">
<title>안전행전부 공통서비스 테스트 사이트(업무사용자)</title>
<script type="text/javascript">
var getContextPath = '<c:out value="${pageContext.request.contextPath}" />';
</script>
<script language="javascript" src="<c:url value='/assets/js/egovframework/com/main.js' />"></script>
									...
									<table width="450" border="0" cellspacing="0" cellpadding="0" style="tableNoWrap">
															<tr>
																<td>
																	...
																	<tr>
																		<td><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />"  border="0"></td>
																		<td>공지사항</td>
																	</tr>
																	</table>
																</td>
												...
												<table width="450" border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td>
																	<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td><img src="<c:url value='/assets/images/egovframework/com/TAB_01.gif' />"  border="0" name="TAB_01" id="TAB_01" style="cursor:pointer;" onClick="fn_changeTAB(this);fnEgovTabNavigation('DIV_01');" onMouseOver="fn_swapImage(this);" onMouseOut="fn_swapImgRestore(this);"></td>
																		<td><img src="<c:url value='/assets/images/egovframework/com/TAB_02_o.gif' />"   border="0" name="TAB_02" id="TAB_02" style="cursor:pointer;" onClick="fn_changeTAB(this);fnEgovTabNavigation('DIV_02');" onMouseOver="fn_swapImage(this);" onMouseOut="fn_swapImgRestore(this);"></td>
																		<td><img src="<c:url value='/assets/images/egovframework/com/TAB_03.gif' />"   border="0" name="TAB_03" id="TAB_03" style="cursor:pointer;" onClick="fn_changeTAB(this);fnEgovTabNavigation('DIV_03');" onMouseOver="fn_swapImage(this);" onMouseOut="fn_swapImgRestore(this);"></td>
																	</tr>
																	</table>
																</td>
															</tr>
											...
											<table width="450" border="0" cellspacing="0" cellpadding="0" style="tableNoWrap">
															<tr>
																<td>
																	<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td><img src="<c:url value='/assets/images/egovframework/com/cmm/icon/tit_icon.gif' />"  border="0" name="TAB_01" id="TAB_01" style="cursor:pointer;" onClick="fn_changeTAB(this);" onMouseOver="fn_swapImage(this);" onMouseOut="fn_swapImgRestore(this);"></td>
																		<td>환율정보</td>
															</tr>
																	</table>
																</td>
