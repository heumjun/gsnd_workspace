...
<layout:extends name="wwwSub">
    ...
    <layout:put block="sidebar" type="REPLACE">
        <c:import url="/inc/sidebar.do">
            <c:param name="menuNo" value="11705000"></c:param>
    ...
    <layout:put block="contents" type="REPLACE">
            ...
            <div class="bbs_list t1o1list1">
                ...
                <table class="t1">
                    <caption class="blind">
                        <strong class="h1">프로그램 신청/취소 현황 목록</strong>
                    </caption>
                    <col style="width:16%" />
                    <col style="width:10%" />
                    <col />
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("a[data-purchsLst-id]").click(function(event) {
                    ...
                    var view_url = "<c:url value="/mypage/prgmMyPayView.do"/>";
