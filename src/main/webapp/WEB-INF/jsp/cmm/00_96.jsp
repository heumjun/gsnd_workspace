...
<head>
	...
	<script language='javascript'>
		...
		if ('${userVO.id}' != null && '${userVO.id}' != '') {
            alert("실명인증이 완료되었습니다. 등록하신 유저아이디는 ${userVO.id} 입니다.");
		} else {
            alert("실명인증이 완료되었습니다. 등록하신 유저아이디는 존재하지않습니다. ");
		}

        //window.opener.location.href='<c:url value="/user/userTerms.do"/>';
        //if ( $.browser.msie ) {
        //    window.opener='Self';
        //    window.open('','_parent','');
        //    window.close();
