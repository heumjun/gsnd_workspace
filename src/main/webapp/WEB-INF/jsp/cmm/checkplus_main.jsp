...
<%
    ...
    String sSiteCode = "BH041";			// NICE로부터 부여받은 사이트 코드
    String sSitePassword = "78rPOtUzNIAc";		// NICE로부터 부여받은 사이트 패스워드
    ...
    String sErrorUrl = "http://localhost:8080/EgovPageLink.do?link=/cmm/checkplus_fail";          // 실패시 이동될 URL
