...
<layout:extends name="wwwSub">
    ...
    <layout:put block="contents" type="REPLACE">
            ...
            <form:form commandName="ReqForm" id="ReqForm" method="post">
                <form:hidden path="exprnId" value="${PrgmForm.exprnId}" />
                ...
                <form:hidden path="exprnNm" value="${PrgmForm.exprnNm}" />

                <!-- fieldset -->
                <fieldset><legend class="blind">주문/결재 작성 폼</legend>
                    <h2 class="hb1 h2">프로그램 정보</h2>
                    <!-- bbs_write -->
                    <div class="bbs_write">
                        <table class="t1">
                            <caption class="blind">
                                <strong class="h1">프로그램 정보 작성 폼</strong>
                            </caption>
                            <col class="order_td_w1" /><col />
                            <tbody>
                            <tr>
                                <th scope="row">프로그램명</th>
                                <td><em>${PrgmForm.exprnNm}</em></td>
                            </tr>
                            <tr>
                                <th scope="row">교육기간</th>
                                <td>${PrgmForm.bgnDe} ~ ${PrgmForm.endDe}</td>
                            </tr>
                            <tr>
                                <th scope="row">교육시간</th>
                                <td>${PrgmForm.exprnTime}</td>
                            </tr>
                            <tr>
                                <th scope="row">수강료</th>
                                <td>
                                    <c:set var="price" value="${PrgmForm.exprnBaseAmt + PrgmForm.exprnMtrAmt}" />
                                    <fmt:formatNumber value="${price}" type="number"  />원 (재료비별도)
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="bbs_write">
                        <table class="t1">
                            ...
                            <tbody>
                            <tr>
                                <th scope="row"><label for="txt_reqNm">예약자</label></th>
                            ...
                            <tr>
                                <th scope="row"><label for="txt_telNo">연락처</label></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><label for="txt_reqEmail">메일주소</label></th>
                                <td><input type="text" id="txt_reqEmail" name="reqEmail" placeholder="email@email.com" class="w50" lang="en" value="${ReqForm.reqEmail}" /></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="txt_exprnNmpr">인원</label></th>
                                <td>
                                    <select id="txt_exprnNmpr" title="인원">
                                        <option value="1" selected="selected">1</option>
                                    <%--    <c:forEach var="i" begin="1" end="${PrgmForm.exprnNmpr - PrgmForm.reqCnt}" step="1">
                                            <c:if test="${i == 1}">
                    ...
                    <div class="order_list">
                        <table class="t1">
                            ...
                            <tr>
                                <td>
                                    <span id="exprnPrice1">
                                    <c:set var="price2" value="${PrgmForm.exprnBaseAmt}" />
                                ...
                                <td>
                                    <span id="exprnPrice2">
                                    <c:set var="price3" value="${PrgmForm.exprnMtrAmt}" />
                                    <fmt:formatNumber value="${price3}" type="number"  /></span>원</td>-->
                                <td><i class="ic2 bsContain"></i></td>
                                <td class="order_total_price">
                                    <span id="exprnPrice3">
                                    <c:set var="price4" value="${PrgmForm.exprnBaseAmt + PrgmForm.exprnMtrAmt}" />
                        ...
                        <table class="t1">
                            ...
                            <tr>
                                ...
                                <td> <span class="order_total_price">
                                     <span id="exprnPrice4">
                                    <c:set var="price5" value="${PrgmForm.exprnBaseAmt + PrgmForm.exprnMtrAmt}" />
                ...
                <div class="infosection1">
                    <p class="tac">
                        ...
                        <a href="<c:url value="/prgm/prgmList.do?pageIndex=1"/>" class="button">취소</a>
                    </p>
                </div>
                <!-- /infosection1 -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#txt_exprnNmpr").change(function() {
                    ...
                    $("#exprnPrice1").html(cnt*${PrgmForm.exprnBaseAmt});
                    $("#exprnPrice2").html(cnt*${PrgmForm.exprnMtrAmt});

                    $("#exprnPrice3").html(cnt*${PrgmForm.exprnBaseAmt+PrgmForm.exprnMtrAmt});
                    $("#exprnPrice4").html(cnt*${PrgmForm.exprnBaseAmt+PrgmForm.exprnMtrAmt});
                ...
                $("#btn_save").click(function() {
                   ...
                   // $("#cashReceiptsOpt").val($(":input:radio[name=txt_cashReceiptsOpt]:checked").val());
                    ...
                    var cnt = $("#txt_exprnNmpr option:selected").val();
                    $("#exprnNmpr").val(cnt);
                    $("#exprnAmt").val(cnt*${PrgmForm.exprnBaseAmt+PrgmForm.exprnMtrAmt});
                    ...
                    if ($(":input:checkbox[name=tosCheck3]:checked").val() != 'Y') {
                        ...
                        var view_url = "<c:url value="/prgm/prgmListSave.do"/>";
