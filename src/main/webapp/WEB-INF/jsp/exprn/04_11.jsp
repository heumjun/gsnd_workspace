...
<layout:extends name="wwwSub">
    ...
    <layout:put block="title" type="REPLACE">
        <c:out value="${sessionScope.title1}"/> &gt; <c:out value="${sessionScope.title2}"/> &gt; 일일체험 예약완료
    </layout:put>
    ...
    <layout:put block="contents" type="REPLACE">
            ...
            <div class="complete1 tac">
                <div class="wrap1">
                    ...
                    <p class="txt2"><span class="tdu">마이페이지 &gt; 체험 신청/취소</span> 현황 메뉴에서 <span class="dpib">예약 내역 확인하세요.</span></p>
                    <!--
                         현장결제 추가로 주석처리
                         2018.07.23
                         ryan.lee added
                ...
                <div class="bbs_write">
                    <table class="t1">
                        <caption>
                            ...
                            <span class="blind" title="요약(summary)">(일일체험명,일시,결재방법,결재금액)</span>
                        </caption>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("a[page-index2]").click(function(event) {
                    ...
                    var view_url = "<c:url value="/mypage/exprnMyList.do"/>";
