...
<layout:extends name="wwwSub">
    ...
    <layout:put block="title" type="REPLACE">
        <c:out value="${sessionScope.title1}"/> &gt; <c:out value="${sessionScope.title2}"/> &gt; 일일체험 결제하기
    </layout:put>
            ...
            <form:form commandName="ReqForm" id="ReqForm" method="post">
                ...
                <fieldset><legend class="blind">결재 작성 폼</legend>
                    ...
                    <div class="bbs_write">
                        <table class="t1">
                            <caption class="blind">
                                <strong class="h1">신청자 정보 작성 폼</strong>
                            </caption>
                ...
                <div class="infosection1">
                    <p class="tac">
                        ...
                        <!-- ryan.lee added 2018.07.23 -->
                        <c:if test="${setleSe == '03'}">
                            <button id="btn_confirm" type="button" value="" class="button submit">예약확인</button>
                        </c:if>
                    </p>
                </div>
                ...
                $("#btn_save").click(function() {
                    ...
                    IMP.request_pay({ // param
                        ...
                        if (rsp.success) {
                            ...
                            // jQuery로 HTTP 요청
                            $.ajax({
                                url: "<c:url value='/exprn/payComplete.do' />"+"?imp_uid="+rsp.imp_uid+"&merchant_uid="+rsp.merchant_uid, // 가맹점 서버
                                type: "POST",
                                dataType: "json",
                                ...
                                switch(data.status) {
                                    case "success":
                                        ...
                                        var view_url = "<c:url value="/exprn/exprnPaySave.do"/>";
