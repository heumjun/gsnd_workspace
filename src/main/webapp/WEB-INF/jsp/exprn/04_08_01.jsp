                                        ...
                                        <ul>
                                            <c:forEach var="result2" items="${dataList}" varStatus="status">
                                                <c:if test="${result.sun == result2.day}">
                                                    <li><a href="#" data-day="${result.sun}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}" data-key="${result2.exprnId}">
                                                        <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
                                    </div>
                                        ...
                                        <ul>
                                            <c:forEach var="result2" items="${dataList}" varStatus="status">
                                                <c:if test="${result.mon == result2.day}">
                                                    <li><a href="#" data-day="${result.mon}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                        <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
                                        ...
                                        <ul>
                                            <c:forEach var="result2" items="${dataList}" varStatus="status">
                                                <c:if test="${result.tue == result2.day}">
                                                    <li><a href="#" data-day="${result.tue}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                        <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
                                        ...
                                        <ul>
                                            <c:forEach var="result2" items="${dataList}" varStatus="status">
                                                <c:if test="${result.wed == result2.day}">
                                                    <li><a href="#" data-day="${result.wed}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                        <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
                                    ...
                                    <ul>
                                        <c:forEach var="result2" items="${dataList}" varStatus="status">
                                            <c:if test="${result.thu == result2.day}">
                                                <li><a href="#" data-day="${result.thu}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                    <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                            </c:if>
                                        </c:forEach>
                                    </ul>
                                    ...
                                    <ul>
                                        <c:forEach var="result2" items="${dataList}" varStatus="status">
                                            <c:if test="${result.fri == result2.day}">
                                                <li><a href="#" data-day="${result.fri}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                    <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                            </c:if>
                                        </c:forEach>
                                    </ul>
                                    ...
                                    <ul>
                                        <c:forEach var="result2" items="${dataList}" varStatus="status">
                                            <c:if test="${result.sat == result2.day}">
                                                <li><a href="#" data-day="${result.sat}" data-time="${result2.text}" data-code="${result2.code}" class="${result2.style}"  data-key="${result2.exprnId}">
                                                    <b class="ic1" title="${result2.text2}">${result2.text3}</b> <span class="t1">${result2.exprnNm}<br/>${result2.text}&nbsp;${result2.text4}</span></a></li>
                                            </c:if>
                                        </c:forEach>
                                    </ul>
            ...
            $(document).ready(function() {
                ...
                $("a[data-day]").click(function(event) {
                    ...
                    $("<form />")
                        ...
                        .append($("<input />").attr("type","hidden").attr("name","exprnId").val(key))
